...
This project is a comprehensive collection of Eclipse RCP and Plugin development examples, likely maintained by [vogella GmbH](https://www.vogella.com). It serves as a reference for modern Eclipse development practices, covering both the classic IDE extension points and the newer Eclipse 4 (e4) application model.
...
- **Generic Editor & TM4E**: Examples of extending the Eclipse Generic Editor with TextMate grammars (TM4E) for languages like Asciidoc and Shell.
- **Language Server Protocol (LSP)**: Integrations for Language Servers (e.g., Dart, Asciidoc).
- **OSGi**: The underlying modular system for all Eclipse plugins.
- **Java 21**: The project is configured to use JavaSE-21.
