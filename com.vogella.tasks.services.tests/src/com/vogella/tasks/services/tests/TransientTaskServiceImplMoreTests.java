...
//    @Test
//    @DisplayName("TransientTaskServiceImpl provides at least one task ")
//    void assertThatTaskServiceCanBeAccessedAsService() {
//    	
//    	BundleContext bundleContext = FrameworkUtil.getBundle(TransientTaskServiceImpl.class).getBundleContext();
//        
//    	ServiceReference<TaskService> serviceReference = bundleContext.getServiceReference(TaskService.class);
//    	TaskService service = bundleContext.getService(serviceReference);
//    	assertNotNull(service);
//    }
